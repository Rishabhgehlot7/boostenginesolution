...
const CancellationRefundPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <p className="text-sm text-gray-600">Last updated on 28-05-2024 16:03:44</p>
      <p className="mt-4">
        GOPAL PATEL believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
      </p>
      <ul className="list-disc list-inside ml-4 mt-4">
        ...
        <li>GOPAL PATEL does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
        <li>
        ...
        <li>In case of complaints regarding products that come with a warranty from manufacturers, please refer the issue to them. In case of any Refunds approved by GOPAL PATEL, it’ll take 1-2 days for the refund to be processed to the end customer.</li>
      </ul>
    </div>
  );
};
