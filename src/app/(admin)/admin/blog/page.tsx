...
export default function Dashboard() {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR<IBlogPost[]>("/api/blog/getBlog", fetcher);
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {Array.isArray(services) &&
                          services?.map((service: IBlogPost) => (
                            <TableRow
                              key={service._id}
                            ...
                            >
                              ...
                              <TableCell>{service.categories[0]}</TableCell>
                              ...
                              <TableCell>
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align="end">
                                    ...
                                    <Link
                                      href={`/admin/blog/updateService/${service._id}`}
                                    >
