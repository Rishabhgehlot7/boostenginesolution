...
export default function Dashboard() {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR<ApplicationSchema[]>("/api/applocation/getApplication", fetcher);
  ...
  const handleDelete = async (id: string) => {
    try {
      const response = await axios.post("/api/applocation/deleteProduct", {
        productId: id,
        cache: "no-store",
      });
                        ...
                        {products
                          ...
                          .map((product: ApplicationSchema) => (
                            ...
                            >
                              ...
                              <TableCell>{product.applicantPhone}</TableCell>
                              <TableCell className="hidden md:table-cell">
                                <a
                                  href={product.resumeUrl}
                                  target="_blank"
                              ...
                              <TableCell>
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align="end">
                                    ...
                                    <Link
                                      href={`/admin/applications/updateApplication/${product._id}`}
                                    >
