...
export default function Dashboard() {
  ...
  function clearAll() {
    ...
    setVariants([]);
    setImageUrls([]);
    setDiscountType("percentage"); // Reset discount type to default
    setDiscountValue(0); // Reset discount value to default

    toast({
      title: "Discarded All Details",
      description:
        "All entered details have been discarded. You can now create a new product.",
      duration: 5000,
    });
  }
